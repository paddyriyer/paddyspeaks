// Purusha Suktam - Interactive Application
// ==========================================
...
(function () {
  ...
  function getTypeLabel(type) {
    switch (type) {
      case 'cosmic': return 'Cosmic Purusha';
  ...
  function renderReading() {
    ...
    html += '<div class="section-divider">The Cosmic Purusha (1&ndash;5)</div>';
    data.verses.forEach(function (v) {
      if (v.type === 'cosmic') html += buildVerseCard(v, 'rc');
    });

    html += '<div class="section-divider">The Cosmic Sacrifice (6&ndash;10)</div>';
    data.verses.forEach(function (v) {
      if (v.type === 'sacrifice') html += buildVerseCard(v, 'rs');
    });

    html += '<div class="section-divider">Creation from the Sacrifice (11&ndash;16)</div>';
    data.verses.forEach(function (v) {
      if (v.type === 'creation') html += buildVerseCard(v, 'rv');
    });
