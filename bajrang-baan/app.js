// Sri Bajrang Baan - Interactive Application
// ============================================

(function () {
  'use strict';

  var data = BAJRANG_BAAN_DATA;
  ...
  function renderAll() {
    ...
    ['doha-1', 'chaupai-1', 'chaupai-2', 'chaupai-3'].forEach(function (id) {
  ...
  function renderHindiOnly() {
    ...
    html += '<div class="section-divider">चौपाई (1&ndash;14)</div>';
