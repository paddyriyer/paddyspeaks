 ...
 *
 *   1. Sticky nav: marks the row .is-stuck once the masthead has scrolled away
 *      (shows the small wordmark and a hairline shadow).
      ...
      .then(function (st) {
        ...
        if (when && st.generated_at) {
          ...
          if (!isNaN(d)) {
            ...
            when.textContent = d.toLocaleString('en-US', { month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit' });
          }
        }
      })
