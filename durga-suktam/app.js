// Durga Suktam - Interactive Application
// ==========================================
...
(function () {
  ...
  function getTypeLabel(type) {
    switch (type) {
      case 'agni': return 'Agni & Crossing';
      case 'protection': return 'Divine Protection';
      case 'durga': return 'Durga Devi';
  ...
  function renderReading() {
    ...
    html += '<div class="section-divider">Agni &amp; Crossing (1&ndash;3)</div>';
    data.verses.forEach(function (v) {
      if (v.type === 'agni') html += buildVerseCard(v, 'ra');
    });

    html += '<div class="section-divider">Divine Protection (4&ndash;6)</div>';
    data.verses.forEach(function (v) {
      if (v.type === 'protection') html += buildVerseCard(v, 'rp');
    });

    html += '<div class="section-divider">Durga Devi (7&ndash;9)</div>';
    data.verses.forEach(function (v) {
      if (v.type === 'durga') html += buildVerseCard(v, 'rd');
    });
